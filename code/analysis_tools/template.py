...
walking_correlations_file = "../submit/output/correlations_craig_tredmil17190"
#walking_correlations_file = "../submit/output/correlations_craig_tredmil12020"
walking_correlations = read_correlations.read_correlations( walking_correlations_file )
walking_correlations.print_stats()
walking_correlations.plot()
