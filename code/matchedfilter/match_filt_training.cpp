              ...
              fio::parameters *PARAMETERS)
{
 ...
 int   select_sensor   = PARAMETERS->get_sensor();
 int   count;
 ...
 while (KIN->valid_start_end (start_time_ref, time_window))
 {
    ...
    /* load into reference */
    KIN->load_sens_ax (ax, start_time_ref, select_sensor, N_window);
    KIN->load_sens_ay (ay, start_time_ref, select_sensor, N_window);
    KIN->load_sens_az (az, start_time_ref, select_sensor, N_window);
               ...
               count++)
    {
       ...
       KIN->load_sens_ax (ax, start_time_data, select_sensor, N_window);
       KIN->load_sens_ay (ay, start_time_data, select_sensor, N_window);
       KIN->load_sens_az (az, start_time_data, select_sensor, N_window);
 ...
 KIN->load_sens_ax (ax, best_start_time, select_sensor, N_window);
 KIN->load_sens_ay (ay, best_start_time, select_sensor, N_window);
 KIN->load_sens_az (az, best_start_time, select_sensor, N_window);
